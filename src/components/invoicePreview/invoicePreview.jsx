                            ...
                            <Row>
                                <Col sm={5} style={{textAlign: "left"}}>
                                    <ul style={{listStyleType: "none", textAlign: "left"}}>
                                        <li><span
                                            className={"invoiceHeader"}>Miejsce wystawienia:</span>{this.state.address}
                                        </li>
                                        <li><span className={"invoiceHeader"}>Data wystawienia:</span> {this.state.date}
                                        </li>
                                        <li><span className={"invoiceHeader"}>Data sprzedaży:</span> {this.state.terms}
                                        </li>
                                    </ul>
                                </Col>
                                <Col> </Col>
                            ...
                            <Row>
                                <Col sm={4} style={{textAlign: "left"}}>
                                    ...
                                    <ul style={{listStyleType: "none"}}>
                                        <li><span
                                            className={"invoiceHeader"}>Nazwa/ Firma:</span> {this.state.businessName}
                                        </li>
                                        ...
                                        <li><span className={"invoiceHeader"}>NIP:</span> {this.state.businessNumber}
                                        </li>
                                        <li><span
